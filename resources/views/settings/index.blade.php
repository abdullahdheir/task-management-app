                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-on-surface-variant font-body-md text-body-md">Set your local time for schedule
                                synchronization.</p>
                        </div>
                        <select
                    ...
                    <div class="border-t border-outline-variant pt-6 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-on-surface-variant font-body-md text-body-md">Switch between light and dark UI
                                themes.</p>
                        </div>
                    ...
                    <div class="border-t border-outline-variant pt-6">
                        ...
                        <input
                            ...
                            type="text" value="Acme Corp Product Team" />
                    </div>
                </div>
            </div>
            <!-- Privacy & Security -->
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-on-surface-variant font-body-md text-body-md">Adds an extra layer of security to
                                your account.</p>
                        </div>
                        <button
                    ...
                    <div class="border-t border-outline-variant pt-6 flex items-center justify-between">
                        <div>
                            <label class="font-label-md text-label-md text-on-surface block mb-1">Share Usage Data</label>
                            <p class="text-on-surface-variant font-body-md text-body-md">Help us improve Focus by sending
                                anonymous analytics.</p>
                        </div>
                        <div class="relative inline-block w-12 h-6">
                            <input checked=""
                                class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-2 border-outline-variant appearance-none cursor-pointer z-10 transition-transform duration-200"
                                id="toggle-data" type="checkbox" />
                            <label
                                class="toggle-label block overflow-hidden h-6 rounded-full bg-outline-variant cursor-pointer transition-colors duration-200"
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="relative inline-block w-12 h-6">
                            <input checked=""
                                class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-2 border-outline-variant appearance-none cursor-pointer z-10 transition-transform duration-200"
                                id="toggle-desktop" type="checkbox" />
                            <label
                                class="toggle-label block overflow-hidden h-6 rounded-full bg-outline-variant cursor-pointer transition-colors duration-200"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="relative inline-block w-12 h-6">
                            <input
                                class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-2 border-outline-variant appearance-none cursor-pointer z-10 transition-transform duration-200"
                                id="toggle-deadline" type="checkbox" />
                            <label
                                class="toggle-label block overflow-hidden h-6 rounded-full bg-outline-variant cursor-pointer transition-colors duration-200"
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <div class="relative group cursor-pointer">
                            <img class="w-16 h-16 rounded-full object-cover border-2 border-primary-fixed"
                                data-alt="A professional headshot of a person with a friendly expression, set against a clean, minimalist studio background with soft bokeh. The lighting is bright and even, fitting a professional productivity app aesthetic. The color palette features soft blues and warm skin tones, conveying trust and reliability."
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDey3t5oTZQ2F34viieJMcN7OOf_a5OYafWYgrwXhhOWenZU6MfFFEh0bVliI9MHE6ZD-jyCWncad4Crai_mPyT-DTrxQaSzTxPeI0JRHKe4ZhH14xJw74IJzv5W6tiG62kUrOCZ9j2oIKHW_P1bRVoWwu8ZW2gUaM6U3LqO2aCZIeYJ8oOCFlAuxaZEreLWVuCk8V5LtCL3OuEGbq9RxDmDG6G0tq1rqgkVeknfTJWDR9_tmvFOMBhgA" />
                            <div
                        ...
                        <div>
                            <h4 class="font-label-md text-label-md text-on-surface">James Dalton</h4>
                            <p class="text-on-surface-variant font-body-md text-body-md">j.dalton@acmecorp.com</p>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <button
