            ...
            <div class="flex justify-between items-end mb-4">
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <span x-text="`${progress}%`" class="font-headline-lg text-headline-lg text-primary"></span>
                        <span class="text-on-surface-variant font-body-md text-body-md">Completed</span>
                    </div>
                </div>
                <div class="text-right">
                    <span class="font-label-md text-label-md text-on-surface-variant"><span x-text="remainingTasks"></span>
                        of
                        {{ $totalTasks }} tasks remaining</span>
                </div>
            </div>
            <div class="w-full h-2 bg-surface-container rounded-full overflow-hidden">
                <div class="h-full bg-secondary transition-all duration-1000 ease-out" :style="`width:${progress}%`"></div>
            </div>
        </div>
        <!-- Bento Grid Layout -->
                            ...
                            <div x-data="{ open: false }" @click.outside="open = false"
                                ...
                                <a href="{{ route('profile.show.user', $member) }}" class="flex items-center gap-3 flex-1">
                                    <img class="w-10 h-10 rounded-full object-cover"
                                        ...
                                        alt="{{ $member->name }}">
                                    <div>
                                        <p class="font-body-lg text-body-lg text-on-surface leading-tight">
                                            {{ $member->name }}
                                        </p>
