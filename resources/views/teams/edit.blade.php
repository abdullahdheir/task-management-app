...
@section('content')
    ...
    <div class="mb-stack-lg">
        <nav class="flex items-center gap-2 text-label-md text-on-surface-variant mb-2">
            <a class="hover:text-primary" href="#">Team</a>
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-on-surface">Edit Team Profile</span>
        </nav>
        <div class="flex justify-between items-end">
            <div>
                <h2 class="font-headline-lg text-headline-lg text-on-surface">Edit Team Profile</h2>
                <p class="text-body-md text-on-surface-variant">Update your team's core identity and manage member access.
                </p>
            </div>
            <div class="flex gap-3">
                <button
                    class="px-4 py-2 border border-outline text-on-surface-variant font-label-md rounded-lg hover:bg-surface-container-low transition-all">Cancel</button>
                <button
                    class="px-6 py-2 bg-primary text-on-primary font-label-md rounded-lg hover:shadow-lg transition-all">Save
                    Changes</button>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-12 gap-gutter-desktop">
        ...
        <div class="col-span-7 space-y-gutter-desktop">
                ...
                <div class="space-y-stack-lg">
                    <div class="flex gap-stack-lg items-start">
                        <div class="relative group cursor-pointer">
                            <div
                                class="w-24 h-24 rounded-2xl bg-surface-container-highest border-2 border-dashed border-outline-variant flex items-center justify-center overflow-hidden">
                            ...
                            <label class="block text-center mt-2 font-label-sm text-primary cursor-pointer">Change
                                Logo</label>
                        </div>
                        <div class="flex-1 space-y-stack-md">
                            <div>
                                <label class="block font-label-md text-on-surface-variant mb-1">Team Name</label>
                                <input
                                    class="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none text-body-lg"
                                    type="text" value="Design Systems Core" />
                            </div>
                            <div>
                                <label class="block font-label-md text-on-surface-variant mb-1">Description</label>
                                <textarea
                                    class="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none text-body-md"
            ...
            <section class="glass-card rounded-xl p-stack-lg shadow-sm">
                <div class="flex justify-between items-center mb-stack-lg">
                    ...
                    <button class="flex items-center gap-1 text-primary font-label-md">
                ...
                <div class="divide-y divide-outline-variant">
                    ...
                    <div class="py-4 flex items-center justify-between group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-label-md text-on-surface">Sarah Jenkins (You)</p>
                                <p class="text-label-sm text-on-surface-variant">sarah.j@focus.app</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <span
                                class="px-2 py-1 bg-primary-container text-on-primary-container text-label-sm rounded uppercase tracking-wider">Owner</span>
                            <button
                                class="p-2 text-on-surface-variant opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="py-4 flex items-center justify-between group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-label-md text-on-surface">Marcus Chen</p>
                                <p class="text-label-sm text-on-surface-variant">marcus.c@focus.app</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <select
                                class="bg-transparent border-none text-label-md text-on-surface-variant focus:ring-0 cursor-pointer">
                                <option>Admin</option>
                                <option selected="">Member</option>
                                <option>Viewer</option>
                            </select>
                            <button
                                class="p-2 text-error opacity-0 group-hover:opacity-100 transition-opacity hover:bg-error-container rounded-full">
                    ...
                    <div class="py-4 flex items-center justify-between group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-label-sm text-on-surface-variant">elena.r@focus.app</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <select
        ...
        <div class="col-span-5 space-y-gutter-desktop">
            ...
            <section class="glass-card rounded-xl p-stack-lg shadow-sm">
                ...
                <div class="space-y-stack-lg">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <p class="font-label-md text-on-surface">Allow member invites</p>
                            <p class="text-label-sm text-on-surface-variant">Members can invite others without admin
                                approval.</p>
                        </div>
                        <input checked=""
                            class="w-5 h-5 rounded-full border-outline-variant text-primary focus:ring-primary"
                            type="checkbox" />
                    </div>
                    <div class="flex items-start justify-between gap-4 border-t border-outline-variant pt-4">
                        <div>
                            <p class="font-label-md text-on-surface">Project Creation</p>
                            <p class="text-label-sm text-on-surface-variant">Limit project creation to Admins only.</p>
                        </div>
                        <input class="w-5 h-5 rounded-full border-outline-variant text-primary focus:ring-primary"
                            type="checkbox" />
                    </div>
                    <div class="flex items-start justify-between gap-4 border-t border-outline-variant pt-4">
                        <div>
                            <p class="font-label-md text-on-surface">Visibility</p>
                            <p class="text-label-sm text-on-surface-variant">Make team discoverable by other teams.</p>
                        </div>
                        <input checked=""
                            class="w-5 h-5 rounded-full border-outline-variant text-primary focus:ring-primary"
                            type="checkbox" />
            ...
            <!-- Danger Zone -->
            <section class="border border-error/20 bg-error-container/10 rounded-xl p-stack-lg">
                <h3 class="font-label-md text-error flex items-center gap-2 mb-2">
                    <span class="material-symbols-outlined text-[18px]">warning</span>
                    Danger Zone
                </h3>
                <p class="text-body-md text-on-surface-variant mb-stack-lg">Deleting a team is permanent. All associated
                    projects, tasks, and historical data will be removed immediately.</p>
                <button
                    class="w-full py-3 border border-error text-error font-label-md rounded-lg hover:bg-error hover:text-on-error transition-all active:scale-[0.98]">
                    Delete Team
                </button>
            </section>
        </div>
    ...
    <script>
        document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                if (this.checked) {
                    parent.querySelector('p:first-child').classList.add('text-primary');
                } else {
                    parent.querySelector('p:first-child').classList.remove('text-primary');
                }
            });
        });
