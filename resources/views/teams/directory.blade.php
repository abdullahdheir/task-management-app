...
@section('content')
    <div class="space-y-stack-lg">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <nav
                    class="flex items-center gap-2 mb-2 text-on-surface-variant font-label-sm text-label-sm uppercase tracking-widest">
                    <span>Teams</span>
                    <span class="material-symbols-outlined text-xs">chevron_right</span>
                    <span class="text-primary font-bold">Product Design</span>
                </nav>
                <h2 class="font-headline-lg text-headline-lg text-on-surface">Team Directory</h2>
                <p class="text-on-surface-variant font-body-md text-body-md mt-1">Manage permissions and view status for 24
                    team
                    members.</p>
            </div>
            <div class="flex gap-stack-md">
                <div class="flex flex-wrap items-center gap-2">
                    <div class="relative">
                        <select
                            class="appearance-none bg-surface border border-outline-variant rounded-lg px-4 py-2 pr-10 font-label-md text-label-md text-on-surface focus:ring-2 focus:ring-primary outline-none cursor-pointer">
                ...
                <button
                    class="flex items-center px-4 py-2 bg-primary text-on-primary rounded-lg font-label-md text-label-md font-bold hover:shadow-lg transition-all"
        ...
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
                    ...
                    <tr class="hover:bg-surface-container transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-label-md text-body-lg font-semibold text-on-surface">Elena Rodriguez
                                    </div>
                                    <div class="text-on-surface-variant font-label-sm text-label-sm">elena.r@focusapp.io
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span
                                class="px-2 py-1 rounded bg-primary-container text-on-primary-container font-label-sm text-label-sm font-bold">Admin</span>
                        </td>
                        <td class="px-6 py-4 font-body-md text-body-md text-on-surface-variant">Product Design</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 rounded-full bg-secondary"></span>
                                <span class="font-label-md text-label-md text-secondary">Active</span>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-surface-container transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-label-md text-body-lg font-semibold text-on-surface">Marcus Chen</div>
                                    <div class="text-on-surface-variant font-label-sm text-label-sm">marcus.c@focusapp.io
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span
                                class="px-2 py-1 rounded bg-surface-container-high text-on-surface-variant font-label-sm text-label-sm font-bold">Member</span>
                        </td>
                        <td class="px-6 py-4 font-body-md text-body-md text-on-surface-variant">Engineering</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 rounded-full bg-tertiary"></span>
                                <span class="font-label-md text-label-md text-tertiary">OOO (Returning Mon)</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <button class="p-2 hover:bg-surface-container-high rounded-full transition-colors">
                    ...
                    <tr class="hover:bg-surface-container transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-label-md text-body-lg font-semibold text-on-surface">Sarah Jenkins
                                    </div>
                                    <div class="text-on-surface-variant font-label-sm text-label-sm">sarah.j@focusapp.io
                                    </div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-surface-container transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-label-md text-body-lg font-semibold text-on-surface">Leo Kostic</div>
                                    <div class="text-on-surface-variant font-label-sm text-label-sm">leo.k@contractor.io
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span
                                class="px-2 py-1 rounded bg-error-container text-on-error-container font-label-sm text-label-sm font-bold">Guest</span>
                        </td>
                        <td class="px-6 py-4 font-body-md text-body-md text-on-surface-variant">Contractor</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 rounded-full bg-outline"></span>
                                <span class="font-label-md text-label-md text-outline">Offline</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <button class="p-2 hover:bg-surface-container-high rounded-full transition-colors">
            ...
            <div class="p-4 bg-surface-container-low border-t border-outline-variant flex items-center justify-between">
                <span class="font-label-md text-label-md text-on-surface-variant">Showing 4 of 24 members</span>
                <div class="flex gap-2">
                    <button
                        class="p-2 rounded-lg border border-outline-variant hover:bg-surface-container-high transition-colors disabled:opacity-50"
                        disabled="">
                        <span class="material-symbols-outlined">chevron_left</span>
                    </button>
                    <button
                        class="p-2 rounded-lg border border-outline-variant hover:bg-surface-container-high transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-stack-lg">
            <div class="p-6 bg-primary-container/10 border border-primary/20 rounded-xl">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-label-md text-label-md font-bold text-primary uppercase">Active Capacity</h3>
                    <span class="material-symbols-outlined text-primary">bolt</span>
                </div>
                <div class="text-3xl font-headline-lg text-on-primary-fixed-variant">88%</div>
                <div class="mt-2 w-full bg-surface-container-high h-1.5 rounded-full overflow-hidden">
                    <div class="bg-primary h-full" style="width: 88%"></div>
                </div>
                <p class="mt-3 font-label-sm text-label-sm text-on-surface-variant">21 members currently active in
                    workspace.
                </p>
            </div>
            <div class="p-6 bg-surface-container-lowest border border-outline-variant rounded-xl">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-label-md text-label-md font-bold text-on-surface-variant uppercase">Role Breakdown</h3>
                ...
                <div class="flex items-end gap-2 h-12">
                    ...
                    <div class="flex-1 bg-primary/30 rounded-t-sm" style="height: 20%"></div>
                </div>
                <div class="mt-3 flex justify-between font-label-sm text-label-sm text-on-surface-variant">
                    <span>Admin (4)</span>
                    <span>Member (18)</span>
                    <span>Guest (2)</span>
                </div>
            ...
            <div class="p-6 bg-surface-container-lowest border border-outline-variant rounded-xl">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-label-md text-label-md font-bold text-on-surface-variant uppercase">Recent Invites</h3>
                    <span class="material-symbols-outlined text-on-surface-variant">mail</span>
                </div>
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="font-body-md text-body-md text-on-surface">j.doe@company.com</span>
                        <span class="font-label-sm text-label-sm text-tertiary">Pending</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="font-body-md text-body-md text-on-surface">m.smith@company.com</span>
                        <span class="font-label-sm text-label-sm text-secondary">Joined</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="hidden fixed inset-0 z-50 flex items-center justify-center bg-on-background/40 backdrop-blur-sm"
        id="invite-modal">
        <div
            class="bg-surface-container-lowest w-full max-w-md rounded-xl shadow-lg overflow-hidden border border-outline-variant">
            <div class="p-6 border-b border-outline-variant flex justify-between items-center">
                <h3 class="font-headline-md text-headline-md text-on-surface">Invite Team Member</h3>
            ...
            <div class="p-6 space-y-4">
                <div class="space-y-1">
                    ...
                    <input
                        class="w-full px-4 py-2 bg-surface border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none font-body-md text-body-md"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1">
                        ...
                        <select
                            class="w-full px-4 py-2 bg-surface border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary outline-none font-body-md text-body-md">
                            <option>Admin</option>
                            <option>Member</option>
            ...
            <div class="p-6 bg-surface-container-low flex justify-end gap-3">
                <button
                    class="px-4 py-2 text-on-surface-variant font-label-md text-label-md font-bold hover:bg-surface-container-high rounded-lg transition-colors"
                    onclick="document.getElementById('invite-modal').classList.add('hidden')">Cancel</button>
                <button
                    class="px-6 py-2 bg-primary text-on-primary font-label-md text-label-md font-bold rounded-lg shadow-md hover:opacity-90 transition-opacity">Send
                    Invite</button>
            </div>
        </div>
    </div>
