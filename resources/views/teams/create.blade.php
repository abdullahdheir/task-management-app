...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8" x-data="{
        ...
        <div class="lg:col-span-7 space-y-8">
            <!-- Team Identity Card -->
            <section
                class="bg-surface-container-lowest rounded-xl border border-outline-variant p-stack-lg shadow-[0px_4px 6px_-1px_rgba(0,0,0,0.05)]">
            ...
            <section
                ...
                <div class="space-y-6">
                    ...
                    <div class="border border-outline-variant rounded-lg overflow-hidden">
                        ...
                        <ul class="divide-y divide-outline-variant bg-white">
                            ...
                            <li
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-body-md text-on-surface font-semibold">{{ auth()->user()->name }}
                                            (You)</p>
                            ...
                            <template x-for="(member, index) in members" :key="index">
                                <li
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center font-bold text-primary">
                                            <span x-text="member.name.substring(0,2).toUpperCase()"></span>
                                        </div>
                                        <div>
                                            <p class="font-body-md text-on-surface font-semibold" x-text="member.name"></p>
                                            <p class="text-xs text-on-surface-variant" x-text="member.email"></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <span
                                            class="bg-surface-container-low text-on-surface-variant px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-tighter"
            ...
            <div class="sticky top-24 space-y-8">
                <section
                    ...
                    <div class="flex flex-col items-center text-center space-y-4">
                        ...
                        <div>
                            <h3 class="font-headline-md text-headline-md text-on-surface" x-text="name || 'New Team'"></h3>
                            <p class="font-body-md text-on-surface-variant line-clamp-2 px-4 italic"
                        ...
                        <div class="flex -space-x-2 pt-2">
                            <div
                                ...
                                {{ auth()->user()->name[0] }}{{ auth()->user()->name[1] ?? '' }}</div>
                            <div class="w-8 h-8 rounded-full border-2 border-white bg-primary-container flex items-center justify-center text-[10px] text-white"
                ...
                <div class="flex gap-4">
                    ...
                    <button @click="submitForm()" :disabled="loading || !name.trim()"
                        ...
                        class="flex-[2] h-12 rounded-lg bg-primary text-on-primary font-label-md text-label-md shadow-lg shadow-primary/20 active:scale-95 transition-all flex items-center justify-center gap-2">
