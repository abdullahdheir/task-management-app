...
@section('content')
    ...
    <div class="mb-stack-lg">
        <p class="font-body-md text-on-surface-variant">Configure your team workspace, manage member permissions, and
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-stack-lg">
        <!-- General Info Card -->
        <section
            class="lg:col-span-7 bg-surface-container-lowest p-stack-lg rounded-xl border border-outline-variant shadow-sm transition-all hover:shadow-md">
            ...
            <div class="space-y-stack-lg">
                <div class="flex flex-col gap-2">
                    <label class="font-label-md text-on-surface-variant">Team Avatar</label>
                    <div class="flex items-center gap-stack-lg">
                        <div
                            class="w-24 h-24 rounded-2xl bg-surface-container-high flex items-center justify-center border-2 border-dashed border-outline-variant relative group cursor-pointer overflow-hidden">
                        ...
                        <div class="space-y-1">
                            <button
                                class="px-4 py-2 bg-primary text-on-primary rounded-lg font-label-md hover:opacity-90 transition-all">Upload
                                New</button>
                            <p class="text-label-sm text-on-surface-variant">Square JPG, PNG or SVG. Max 2MB.</p>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-stack-md">
                    <div class="flex flex-col gap-1">
                        <label class="font-label-md text-on-surface-variant">Team Name</label>
                        <input
                            class="w-full px-4 py-3 rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary text-body-lg bg-surface"
                            type="text" value="Design Systems" />
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="font-label-md text-on-surface-variant">Description</label>
                        <textarea
                            class="w-full px-4 py-3 rounded-lg border border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary text-body-md bg-surface"
                ...
                <div class="pt-stack-md flex justify-end">
                    <button
                        class="px-6 py-2.5 bg-primary text-on-primary rounded-lg font-label-md shadow-sm hover:translate-y-[-1px] active:translate-y-0 transition-all">Save
                        Changes</button>
                </div>
            </div>
        </section>
        ...
        <section
            class="lg:col-span-5 bg-primary-container text-on-primary-container p-stack-lg rounded-xl flex flex-col justify-between">
            <div>
            ...
            <div class="mt-8 space-y-4">
                <div class="flex justify-between items-end">
                    ...
                    <span class="font-headline-md font-bold text-on-primary-container">12</span>
                </div>
                <div class="w-full bg-white/20 h-2 rounded-full overflow-hidden">
                    <div class="bg-secondary-fixed h-full w-[85%]"></div>
                </div>
            ...
            <button
                class="mt-stack-lg w-full py-3 bg-white text-primary rounded-lg font-label-md font-bold hover:bg-surface transition-colors">View
                Detailed Report</button>
        </section>
        <!-- Permissions Section -->
        <section
            class="lg:col-span-12 bg-surface-container-lowest p-stack-lg rounded-xl border border-outline-variant shadow-sm">
            <div class="flex items-center gap-2 mb-stack-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-stack-lg">
                <!-- Permission Item -->
                <div class="flex items-start justify-between py-stack-md border-b border-outline-variant">
                    <div>
                        <p class="font-body-lg font-medium">Allow members to invite</p>
                        <p class="text-label-sm text-on-surface-variant">Non-admins can send invitations to new
                            collaborators.</p>
                    </div>
                ...
                <div class="flex items-start justify-between py-stack-md border-b border-outline-variant">
                    <div>
                        ...
                        <p class="text-label-sm text-on-surface-variant">Restrict project creation to Team Admins
                            and Managers.</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="flex items-start justify-between py-stack-md border-b border-outline-variant">
                    <div>
                        ...
                        <p class="text-label-sm text-on-surface-variant">Allow sharing project boards via unique
                            public links.</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input checked="" class="sr-only peer" type="checkbox" />
                ...
                <div class="flex items-start justify-between py-stack-md border-b border-outline-variant">
                    <div>
                        ...
                        <p class="text-label-sm text-on-surface-variant">Managers can view and download team
                            invoices.</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input checked="" class="sr-only peer" type="checkbox" />
        ...
        <section class="lg:col-span-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-stack-lg">
                <!-- Slack Integration -->
                <div
                    class="bg-surface-container-lowest p-stack-lg rounded-xl border border-outline-variant flex flex-col items-center text-center hover:shadow-md transition-all">
                    ...
                    <p class="text-label-md text-on-surface-variant mb-stack-lg">Sync task updates and notifications
                        directly to channels.</p>
                    <button
                        class="mt-auto w-full py-2 border border-primary text-primary rounded-lg font-label-md hover:bg-primary/5 transition-colors">Configure</button>
                </div>
                <!-- GitHub Integration -->
                <div
                    class="bg-surface-container-lowest p-stack-lg rounded-xl border border-outline-variant flex flex-col items-center text-center hover:shadow-md transition-all">
                    ...
                    <p class="text-label-md text-on-surface-variant mb-stack-lg">Link pull requests to Focus tasks
                        automatically.</p>
                    <button
                        class="mt-auto w-full py-2 bg-primary text-on-primary rounded-lg font-label-md hover:opacity-90 transition-colors">Connect</button>
                </div>
                ...
                <div
                    ...
                    <p class="text-label-md text-on-surface-variant mb-stack-lg">Sync deadlines and team milestones
        ...
        <!-- Danger Zone -->
        <section class="lg:col-span-12 p-stack-lg rounded-xl border border-error bg-error-container/20 mt-stack-lg">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-stack-md">
                <div>
                    <h4 class="font-headline-md text-headline-md text-error flex items-center gap-2">
                        <span class="material-symbols-outlined">warning</span>
                        Danger Zone
                    </h4>
                    <p class="text-body-md text-on-surface-variant mt-1">Deleting this team will permanently remove
                        all associated tasks, files, and project history. This action cannot be undone.</p>
                </div>
                <button
                    class="shrink-0 px-6 py-2.5 bg-error text-on-error rounded-lg font-label-md hover:bg-opacity-90 transition-all">Delete
                    Team</button>
            </div>
        </section>
    </div>
